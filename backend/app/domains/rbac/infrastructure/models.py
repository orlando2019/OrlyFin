...
# Modela la responsabilidad de 'role' dentro del dominio o capa actual.
...
# Modela la responsabilidad de 'permission' dentro del dominio o capa actual.
...
# Modela la responsabilidad de 'user role' dentro del dominio o capa actual.
...
# Modela la responsabilidad de 'role permission' dentro del dominio o capa actual.
